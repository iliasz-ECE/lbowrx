...
from owrx.controllers.state import InitialStateController, CurrentStateController
...
class Router(object):
    def __init__(self):
        self.routes = [
            ...
            StaticRoute("/initstate.json", InitialStateController),
            StaticRoute("/curstate.json", CurrentStateController),
