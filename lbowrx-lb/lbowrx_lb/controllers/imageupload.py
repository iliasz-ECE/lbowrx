...
from lbowrx_lb.controllers import BodySizeError
from lbowrx_lb.controllers.assets import AssetsController
...
class ImageUploadController(AuthorizationMixin, AssetsController):
    ...
    def getFilePath(self, file=None):
        ...
        return "{tmp}/{file}".format(
            tmp=CoreConfig.get_shared_config().get_temporary_directory(),
            file=self.file
        )
